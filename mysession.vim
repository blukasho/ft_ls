...
badd +39 srcs/ft_ls/read_file.c
...
badd +59 srcs/ft_ls/print_only_files.c
...
silent! normal! zE
let s:l = 54 - ((52 * winheight(0) + 35) / 70)
...
wincmd w
argglobal
edit ~/Documents/projects/ft_ls/srcs/ft_ls/main.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
edit ~/Documents/projects/ft_ls/srcs/ft_ls/ft_ls.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
exe '4resize ' . ((&lines * 34 + 36) / 73)
exe 'vert 4resize ' . ((&columns * 93 + 140) / 281)
tabedit ~/Documents/projects/ft_ls/srcs/ft_ls/print_dir.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
edit ~/Documents/projects/ft_ls/srcs/ft_ls/standart_output.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
edit ~/Documents/projects/ft_ls/srcs/ft_ls/init_structs.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((9 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
