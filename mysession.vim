...
badd +1 ../ft_printf/Makefile
badd +14 srcs/ft_strlen.c
badd +15 srcs/ft_ls/curr_dir.c
badd +1 ~/.vim/vimrc
badd +10 srcs/ft_ls/open.c
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((41 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((12 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
